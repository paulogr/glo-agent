/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fed5ea40fa5fce2ba947c6bd6fc67c23)
// Runtime types generated with workerd@1.20260617.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	GLO_AI_GATEWAY_ID: "default";
	GLO_AI_MODEL: "@cf/mistralai/mistral-small-3.1-24b-instruct";
	SLACK_CLIENT_ID: string;
	SLACK_CLIENT_SECRET: string;
	SLACK_SIGNING_SECRET: string;
	SLACK_APP_TOKEN: string;
	GloOperationsAgent: DurableObjectNamespace<import("./src/index").GloOperationsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GloOperationsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GLO_AI_GATEWAY_ID" | "GLO_AI_MODEL" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "SLACK_APP_TOKEN">> {}
}
